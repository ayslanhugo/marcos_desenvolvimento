...
# docker build -t marcos_desenvolvimento .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name marcos_desenvolvimento marcos_desenvolvimento
